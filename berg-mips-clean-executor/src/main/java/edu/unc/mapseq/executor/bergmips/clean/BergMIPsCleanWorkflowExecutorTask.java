...
import edu.unc.mapseq.workflow.bergmips.clean.BergMIPsCleanWorkflow;

public class BergMIPsCleanWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(BergMIPsCleanWorkflowExecutorTask.class);
    ...
    public BergMIPsCleanWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    BergMIPsCleanWorkflow cleanWorkflow = new BergMIPsCleanWorkflow();
