...
public class BergMIPsCleanMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(BergMIPsCleanMessageListener.class);

    public BergMIPsCleanMessageListener() {
        super();
    }
