package edu.unc.mapseq.workflow.bergmips.clean;
...
public class BergMIPsCleanWorkflow extends AbstractSequencingWorkflow {

    private static final Logger logger = LoggerFactory.getLogger(BergMIPsCleanWorkflow.class);

    public BergMIPsCleanWorkflow() {
        super();
    }
